...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        List<String> origins = StringUtils.commaDelimitedListToSet(corsAllowedOrigins).stream()
                .map(String::trim)
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/invoices/**", "/api/bills/**", "/api/shorteners/**", "/api/qr-codes/**", "/api/image-uploads/**", "/api/categories/**", "/api/items/**", "/api/carts/**", "/api/transactions/**", "/api/ratings/**", "/api/users/**", "/api/messages/**", "/api/wall/**").authenticated()
